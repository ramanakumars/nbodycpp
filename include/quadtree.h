...
public:
    ...
    QuadTree<T>(double xmin, double ymin, double width, double height, int _depth, QuadTree<T> *_parent)
    {
...
private:
    void subdivide()
    {
        children[0] = new QuadTree<T>(bounds.xmin, bounds.ymin + bounds.height / 2, bounds.width / 2, bounds.height / 2, depth + 1, this);
        children[1] = new QuadTree<T>(bounds.xmin + bounds.width / 2, bounds.ymin + bounds.height / 2, bounds.width / 2, bounds.height / 2, depth + 1, this);
        children[2] = new QuadTree<T>(bounds.xmin, bounds.ymin, bounds.width / 2, bounds.height / 2, depth + 1, this);
        children[3] = new QuadTree<T>(bounds.xmin + bounds.width / 2, bounds.ymin, bounds.width / 2, bounds.height / 2, depth + 1, this);
        is_divided = true;
